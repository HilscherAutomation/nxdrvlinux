                                     ...
                                     uint32_t        ulFileDataLen)
{
  ...
  } else
  {
    ...
    } else
    {
      ...
      uint32_t ulState = LE32_TO_HOST(HWIF_READ32(ptDevInstance, ptGlobalRegisters->ulSystemState));
      ...
      HWIF_WRITE32(ptDevInstance, ptGlobalRegisters->ulSystemState, HOST_TO_LE32(ulState));
